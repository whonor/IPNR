...
def preprocess_MIND_small():
    ...
    if not os.path.exists(train_set_root + '/news.tsv'):
        shutil.copyfile(MIND_small_dataset_root + '/download/train/news_.tsv', train_set_root + '/news.tsv')
    ...
    if not os.path.exists(dev_set_root + '/news.tsv'):
        shutil.copyfile(MIND_small_dataset_root + '/download/train/news_.tsv', dev_set_root + '/news.tsv')
    ...
    if not os.path.exists(test_set_root + '/news.tsv'):
        shutil.copyfile(MIND_small_dataset_root + '/download/dev/news_.tsv', test_set_root + '/news.tsv')
