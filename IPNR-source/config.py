...
import numpy as np
import json
from prepare_MIND_dataset import prepare_MIND_200k, prepare_MIND_large, prepare_MIND_small
...
class Config:
    def parse_argument(self):
        ...
        parser.add_argument('--news_encoder', type=str, default='IPNR', choices=['IPNR', 'CNE', 'CNN', 'MHSA', 'KCNN', 'HDC', 'NAML', 'PNE', 'DAE', 'Inception', 'NAML_Title', 'NAML_Content', 'CNE_Title', 'CNE_Content', 'CNE_wo_CS', 'CNE_wo_CA'], help='News encoder')
        parser.add_argument('--user_encoder', type=str, default='IPNR', choices=['IPNR', 'LSTUR', 'MHSA', 'ATT', 'CATT', 'FIM', 'PUE', 'GRU', 'OMAP', 'SUE_wo_GCN', 'SUE_wo_HCA'], help='User encoder')
        ...
        # Dataset config
        parser.add_argument('--dataset', type=str, default='small', choices=['tiny', '200k', 'small', 'large'], help='Dataset type')
        ...
        parser.add_argument('--num_concepts', type=int, default=1,
                            help='Number of concepts for building graph')
        parser.add_argument('--concept_num_per_news', type=int, default=20,
                            help='Maximum number of concept for concept embedding')
        ...
        parser.add_argument('--cnn_window_size', type=int, default=5, help='Window size of CNN kernel')
        ...
        parser.add_argument('--hidden_dropout_prob', type=float, default=0.2, help='')
        parser.add_argument('--num_hidden_layers', type=int, default=2, help='')
        parser.add_argument('--hidden_act', type=str, default="gelu", help='')
        parser.add_argument('--num_attention_heads', type=int, default=20, help='')
        parser.add_argument('--intermediate_size', type=int, default=256, help='')
        parser.add_argument('--max_position_embeddings', type=int, default=256, help='')
        parser.add_argument('--type_vocab_size', type=int, default=2, help='')
        parser.add_argument('--vocab_size', type=int, default=100000, help='')
        ...
        parser.add_argument('--pooler_type', type=str, default="weightpooler", help='')
        parser.add_argument('--enable_fp16', type=str, default="False", help='')
